# отвечает за запуск, игровой цикл и парсинг команд
    ...
    while True:
        ...
        try:
            ...
            if command == 'create_table':
                if len(args) < 3:
                    print('Недостаточно аргументов. Формат: create_table '
                          '<имя> <столбец:тип> ...')
                    continue
                table_name = args[1]
                columns = args[2:]
                ...
                if (
                    ...
                    print('Неверный формат. Используйте: insert into '
                          '<таблица> values (<значение1>, <значение2>, ...)')
                    continue
                ...
                if (
                    not values_str.startswith('(')
                    or not values_str.endswith(')')
                ):
                ...
                if len(args) < 3 or args[1].lower() != 'from':
                    print('Неверный формат. Используйте: select from '
                ...
                if len(args) < 4:
                    print('Неверный формат. Используйте: update <таблица> set '
                          '<столбец>=<значение> where <столбец>=<значение>')
                    continue
                ...
                if len(args) < 4:
                    print('Неверный формат. Используйте: delete from <таблица>'
                          ' where <условие>')
                    continue
                ...
                if len(args) != 2:
                    ...
                    continue
                table_name = args[1]
                get_table_info(metadata, table_name)
